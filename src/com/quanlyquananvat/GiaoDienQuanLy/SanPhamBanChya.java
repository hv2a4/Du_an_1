...
public class SanPhamBanChya extends javax.swing.JDialog {

    ThongKeDao tkdao = new ThongKeDao();

    public SanPhamBanChya(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        init();
    ...
    public void fillTable() {
        ...
        model.setRowCount(0);
        try {
            List<Object[]> list = tkdao.getSoLuongDaBan();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Thống kê bán chạy");
        ...
        tblTienMat.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Tên sản phẩm", "Số lượng  ", "Ngày tạo", "Số lượng bán"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SanPhamBanChya.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SanPhamBanChya dialog = new SanPhamBanChya(new javax.swing.JFrame(), true);
