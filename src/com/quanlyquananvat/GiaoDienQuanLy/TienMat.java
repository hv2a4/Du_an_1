...
public class TienMat extends javax.swing.JDialog {

    ThongKeDao tkdao = new ThongKeDao();

    public TienMat(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        init();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Thống kê tiền mặt");
        ...
        tblTienMat.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã nhân viên", "Mã khách hàng", "Số lượng hóa đơn", "Tổng doanh thu"
            }
        ) {
    ...
    public void fillTable() {
        ...
        model.setRowCount(0);
        try {
            List<Object[]> list = tkdao.getDataTienMat();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TienMat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TienMat dialog = new TienMat(new javax.swing.JFrame(), true);
