...
public class DoanhThuSanPham extends javax.swing.JDialog {
    
    ThongKeDao tkdao = new ThongKeDao();
    
    public DoanhThuSanPham(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        init();
    ...
    public void fillTable() {
        ...
        model.setRowCount(0);
        try {
            List<Object[]> list = tkdao.getThongKeSanPham();
            for (Object[] objects : list) {
                model.addRow(new Object[]{
                    objects[0],
                    objects[1],
                    NumberFormatter.formatCurrency((double) objects[2]),
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Thống kê doanh thu sản phẩm");
        ...
        tblTienMat.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Tên sản phẩm", "Số lượng hóa dơn", "Tổng doanh thu", "Doanh thu trung binh"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DoanhThuSanPham.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DoanhThuSanPham dialog = new DoanhThuSanPham(new javax.swing.JFrame(), true);
