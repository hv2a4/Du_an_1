...
public class SanPham extends javax.swing.JPanel {
    ...
    public void update() {
        ...
        try {
            ...
            this.fillTable();
            this.clearnForm();
            MsgBox.alert(this, "Sủa thông tin thành công!");
        } catch (Exception e) {
            e.printStackTrace();
            MsgBox.error(this, "Sửa thông tin thất bại!");
        }
    }
    ...
    private LoaiSanPham loaiSanPhamDialog;

    public void setLoaiSanPhamDialog(LoaiSanPham loaiSanPhamDialog) {
        this.loaiSanPhamDialog = loaiSanPhamDialog;
    }
