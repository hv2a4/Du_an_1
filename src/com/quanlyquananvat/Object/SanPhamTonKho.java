...
public class SanPhamTonKho extends javax.swing.JDialog {

    ThongKeDao tkdao = new ThongKeDao();

    public SanPhamTonKho(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        init();
    ...
    public void fillTable() {
        ...
        model.setRowCount(0);
        try {
            List<Object[]> list = tkdao.getSoLuongSanPhamTonKho();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Thống kê doanh tồn kho ");
        ...
        tblTienMat.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Tên sản phẩm", "Số lượng  tồn kho", "Tổng doanh thu", "Doanh thu trung binh"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SanPhamTonKho.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SanPhamTonKho dialog = new SanPhamTonKho(new javax.swing.JFrame(), true);
